...
@ApplicationPath("/")
@OpenAPIDefinition(info = @Info(title = "Academico Web API", version = "1.0", description = "WEB API utilizando o estilo arquitetural REST"), servers = {
        @Server(description = "Desenvolvimento", url = "/academico-web-api")
})
public class AcademicoResourceConfig extends ResourceConfig {
    ...
    private void resgistrarEndPoints() {
        System.out.println("[Configurando a classes resources/endpoints da aplicação");
