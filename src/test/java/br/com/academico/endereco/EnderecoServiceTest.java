...
public class EnderecoServiceTest {
    ...
    public void teste_criar_endereco() {
        Endereco endereco = new Endereco(33333, "Rua H", "Centro", "Tobias Barreto", "Sergipe", 444);
    ...
    public void teste_atualizar_endereco_por_id(){
        Endereco endereco = new Endereco(99999999, "Rua N", "Centro", "Tobias Barreto", "Sergipe", 444);
